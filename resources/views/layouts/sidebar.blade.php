    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item">
                    <button type="button" class='sidebar-link' data-bs-toggle="modal" data-bs-target="#logoutModal">
...
<div class="modal fade modal-borderless" id="logoutModal" tabindex="-1" aria-labelledby="logoutModalLabel" aria-hidden="true">
