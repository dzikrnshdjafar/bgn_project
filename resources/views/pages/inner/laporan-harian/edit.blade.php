...
<x-app-layout>
    <section class="row">
        <div class="col-12">
            <x-form-card :title="'Edit Laporan Harian Kehadiran'" :backLink="route('laporan-harian.index')">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <div class="alert alert-light-info">
                                ...
                                <strong>{{ $laporan->sekolah->nama_sekolah }}</strong><br>
                                Perbarui data kehadiran siswa untuk tanggal {{ \Carbon\Carbon::parse($laporan->tanggal)->format('d/m/Y') }}.
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="date" 
                                       ...
                                       id="tanggal" 
                                       name="tanggal" 
                                       value="{{ \Carbon\Carbon::parse($laporan->tanggal)->format('Y-m-d') }}" 
                                       readonly
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="total_siswa" 
                                       name="total_siswa" 
                                       value="{{ old('total_siswa', $laporan->total_siswa) }}" 
                                       required>
                                @error('total_siswa')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">Dapat diubah jika ada perubahan jumlah siswa</small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="siswa_hadir" 
                                       name="siswa_hadir" 
                                       value="{{ old('siswa_hadir', $laporan->siswa_hadir) }}" 
                                       required 
                                       min="0"
                                       onchange="calculateTidakHadir()"
                                       oninput="calculateTidakHadir()">
                                @error('siswa_hadir')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('siswa_tidak_hadir', $laporan->siswa_tidak_hadir) }}" 
                                       readonly 
                                       style="background-color: #e9ecef;">
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('keterangan') is-invalid @enderror" 
                                          ...
                                          name="keterangan" 
                                          rows="4" 
                                          placeholder="Tambahkan catatan atau keterangan khusus untuk laporan ini...">{{ old('keterangan', $laporan->keterangan) }}</textarea>
                                @error('keterangan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Also recalculate when total_siswa changes
            document.getElementById('total_siswa').addEventListener('input', calculateTidakHadir);
        });
    </script>
    @endpush
</x-app-layout>
