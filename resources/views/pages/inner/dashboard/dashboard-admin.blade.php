...
<x-app-layout>
    ...
    <div class="page-content">
        <section class="row">
            ...
            <div class="col-12 col-lg-9">
                ...
                {{-- Grafik Distribusi per SPPG --}}
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Distribusi yang Sudah Diterima per SPPG</h4>
                            </div>
                            <div class="card-body">
                                <div id="chartDistribusiSppg"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    @push('scripts')
    <script>
        // Data untuk grafik distribusi per SPPG
        const sppgNames = @json($distribusiPerSppg->pluck('nama_dapur'));
        const distribusiCounts = @json($distribusiPerSppg->pluck('total_diterima'));

        const chartOptions = {
            series: [{
                name: 'Distribusi Diterima',
                data: distribusiCounts
            }],
            chart: {
                type: 'bar',
                height: 350,
        ...
        const chart = new ApexCharts(document.querySelector("#chartDistribusiSppg"), chartOptions);
        chart.render();
    </script>
    @endpush
</x-app-layout>
